  ...
  return (
    <Section id="fixed-target" >
      ...
      <Right>
        ...
        <img src={img2} className="small-img-1" alt="About us" data-scroll data-scroll-speed="5" />
        <img src={img3} className="small-img-2" alt="About us" data-scroll data-scroll-speed="-2" />
      </Right>
    </Section>
  );
};
